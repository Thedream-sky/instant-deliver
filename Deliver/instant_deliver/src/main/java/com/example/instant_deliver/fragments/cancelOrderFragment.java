...
public class cancelOrderFragment extends Fragment {
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            if(msg.what==1){
                //获取数据
                orderManager.refreshData(getActivity().getApplicationContext(),callBack,flag,userid,listviewForScrollView,"4",pullToRefreshScrollView);
            }
        }
    };
    ...
    public cancelOrderFragment(String flag){
        this.flag =flag;
    }
    ...
    private void init(){
        pullToRefreshScrollView = (PullToRefreshScrollView) view.findViewById(R.id.cancel_order_scrollView);
        listviewForScrollView = (ListviewForScrollView) view.findViewById(R.id.cancel_order_listView);
