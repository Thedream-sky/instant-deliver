...
public class eatFragment extends Fragment {
    ...
    //初始化控件
    private void init() {
        scrollView = (PullToRefreshScrollView) view.findViewById(R.id.eat_scrollView);
        mylistView = (ListviewForScrollView) view.findViewById(R.id.eat_listView);
        //手动把ScrollView滚动至最顶端
        scrollView.smoothScrollTo(0, 0);
        warn = (TextView) view.findViewById(R.id.eat_warn);
