...
public class finishedFragment extends Fragment {
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            if(msg.what==1){
                //获取数据
                orderManager.refreshData(getActivity().getApplicationContext(),callBack,flag,userid,listviewForScrollView,"3",pullToRefreshScrollView);
            }
        }
    };
    ...
    public finishedFragment(String flag){
        this.flag =flag;
    }
    ...
    private void init(){
        pullToRefreshScrollView = (PullToRefreshScrollView) view.findViewById(R.id.finished_order_scrollView);
        listviewForScrollView = (ListviewForScrollView) view.findViewById(R.id.finished_order_listView);
